	...
	class UtahThemeOptions
	{
		...
		public function getOptions()
		{
			...
			if (!is_array($options))
			{
				...
				// social / feeds
				$options['facebook_url'] = 'http://www.facebook.com';
				// social / feeds
				$options['email_url'] = '';
				...
				// footer options
				$options['department_logo'] = '';
				$options['department_name'] = '';
				$options['department_address'] = '';
				$options['department_address2'] = '';
				$options['department_phone'] = '';
		...
		public function add()
		{
			if(isset($_POST['utah_theme_save']))
			{
				...
				$options['email_url'] = filter_var(stripslashes($_POST['email_url']), FILTER_SANITIZE_URL);
		...
		<div class="wrap">
			...
			<div id="theme_option_tabs">
				<ul>
					...
					<li><a href="#utah_university_header"><?php _e('Theme Header', THEME_L10N_NAME); ?></a></li>
					<li><a href="#utah_university_footer"><?php _e('Theme Footer', THEME_L10N_NAME); ?></a></li>
...
?>
				...
				<div id="utah_university_footer">
					<h3><?php _e('Footer', THEME_L10N_NAME); ?></h3>
					<table class="form-table">
						<tbody>
							<tr>
								<td valign="top" width="20%">
									<?php _e('Logo URL:', THEME_L10N_NAME); ?>
								</td>
								<td valign="top">
							...
							<tr>
								<td valign="top" width="20%">
									<?php _e('Address Line 1:', THEME_L10N_NAME); ?>
								</td>
								<td valign="top">
							...
							<tr>
								<td valign="top">
									<?php _e('Address Line 2:', THEME_L10N_NAME); ?>
								</td>
								<td valign="top">
				...
				<div id="utah_social">
					...
					<table class="form-table">
						<tbody>
							...
							<tr>
								<td width="20%" valign="top">
									<?php _e('Link to email list sign up form:', THEME_L10N_NAME); ?>
								</td>
								<td valign="top">
									<input type="text" name="email_url" id="email_url"
												 class="code" style="width:98%;" value="<?php echo($options['email_url']); ?>" />
								</td>
							</tr>
