...
(function($){
    ...
    userMeta.formEditor = {
        ...
        addNewField: function() {
            ...
            data: arg,
                ...
                success: function( data ){
                    ...
                    $('#um_admin_field_' + newID).find('.um_multiselect').multiselect({
                        includeSelectAllOption: true
                    });
                }
            }); 
        ...
        steadySidebar: function() {
            ...
            if ( FieldsContainerHeight < windowHeight ) {
        ...
        loadConditionalConfig: function() {
            this.editor.find('.panel-body .um_parent').each(function(){
                ...
                var child = $(this).closest('.panel-body').find('input[name='+ $(this).attr('data-child') +']');
                if ( $(this).is(":checked") ) {
                    child.closest('p').slideDown();
                } else {
                    child.closest('p').slideUp();
                }
            });
        },
        
        toggleConditionalConfig: function() {
            // Implemented for checkbox
            var child = $(this).closest('.panel-body').find('input[name='+ $(this).attr('data-child') +']');
            if ( $(this).is(":checked") ) {
                child.closest('p').slideDown();
